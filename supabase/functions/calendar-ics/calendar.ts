// COPY of src/lib/calendar.ts — keep in sync (only the types import path
// differs; the edge function bundle can't reach src/). If the engine changes,
// copy it here and redeploy calendar-ics or the feed serves stale logic.
