  ...
  return (
    <div className="fixed inset-0 z-50 overflow-y-auto" style={{ background: 'var(--page)' }}>
      <div className="max-w-3xl mx-auto px-6 py-8">
        ...
        <Rule term="The ledger">"Monthly in &amp; out" → Ledger is the household spreadsheet, generated: month blocks of dated rows with a running balance down the side. Click any amount to correct that ONE date — a rainy February power bill, a paycheck that didn't land. The recurring row keeps its usual number, so a year of corrections never drifts the model, and every other figure in Juno moves with the correction the moment you type it.</Rule>
        <Rule term="Day by day">The Dashboard's cash chart also runs the other way: every bill and paycheck on its real due date, starting today rather than next month, running-summed from today's liquid cash. Nothing is smoothed, so a biweekly paycheck gives you three-paycheck months and an every-4-months bill only lands every fourth month. It's there because a month that ends fine can still go under on the 20th — that dip is what a household living close to the line actually steers by. Flows with no due day sit it out and are listed under the chart.</Rule>
